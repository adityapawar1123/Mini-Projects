...
engine.say(q1name_random)
print(f"{q1name_random}")
engine.runAndWait()
...
if name.strip().lower() in ["no", "nah", "nope", "i don't wanna tell you my name", "no thanks", "i ain't telling you my name"] :
  ...
  engine.say(no_name_roasts_random)
  print(no_name_roasts_random)
  engine.runAndWait()
  ...
  exit()
   ...
   engine.say(int_name_roasts_random)
   print(int_name_roasts_random)
   engine.runAndWait()
   engine.say("Well looks like no jokes for you then")
   print("Well looks like no jokes for you then🥰")
   engine.runAndWait()
 ...
 if 5 < time <= 12:
  ...
  engine.say(f"Looks like you're a night owl {name}!")
  print(f"Looks like you're a night owl {name}!")
  engine.runAndWait()
...
engine.say(q2_category_random)
print(q2_category_random)
engine.runAndWait()
engine.say("The available categories are mentioned below")
engine.runAndWait()
...
while True : 
  ...
  engine.say(q3_joke_loop_random)
  print(q3_joke_loop_random)
  engine.runAndWait()
  ...
  if joke_loop_input.strip().lower() in [
    ...
    engine.say(not_funny_roasts_random)
    print(not_funny_roasts_random)
    engine.runAndWait()

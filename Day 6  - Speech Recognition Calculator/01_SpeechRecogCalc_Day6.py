...
if r.recognize_google(audio_text) in ["square it" ,"square", "raise power to two", "raise power to 2"] : 
    ...
    elif r.recognize_google(audio_text) in ["divide", "division", "divide them", "i want you to divide them"] : 
       if b != 0 :
    ...
    elif r.recognize_google(audio_text) in ["remainder", "remainder of", "division remainder", "what's their remainder"] :
     if b != 0 : 

...
while True :
 ...
 engine.say("Do you want me to perform another operation?")
 engine.runAndWait()

 loop_q = input("Do you want me to perform another operation?(yes/no): ").strip().lower()
 if loop_q not in ["yes", "yeah", "yea", "yh", "ya", "ok", "okay", "yessir", "yess", "yessirr"] : 
   engine.say("Okay Albert Einstein!")
   engine.runAndWait()
   print("Run again to perform any calculations.")
   break